...
namespace ORB_SLAM2
{
    ...
    public:
        ...
        cv::Mat GrabImageRGBD(const cv::Mat &imRGB, const cv::Mat &imD, const cv::Mat &imSem, const double &timestamp);
    ...
    public:
        ...
        // Shared immutable curve settings. Initialized before worker threads start.
