...
#define FRAME_GRID_COLS 64
    ...
    public:
        ...
        void ExtractCurve(const cv::Mat &mImGray, const cv::Mat &depth, const CurveConfigPtr &curveConfigPtr, const cv::Mat &Sem = cv::Mat());

        void assignProperty3DEach(orderedEdgePoint &pt, const cv::Mat &matDepth, const CurveConfigPtr &curveConfigPtr);
    ...
    public:
        ...
        std::vector<bool> mvbCurveOutlier;
