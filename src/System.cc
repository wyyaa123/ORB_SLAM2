...
namespace ORB_SLAM2
{
                                            ...
                                            mbDeactivateLocalizationMode(false)
    {
        ...
        mCurveConfig = std::make_shared<CurveConfig>(strSettingsFile, mSensor == RGBD);
        ...
        mpTracker->mCurveConfig = mCurveConfig;

        // Initialize the Local Mapping thread and launch
        mpLocalMapper = new LocalMapping(mpMap, mSensor == MONOCULAR);
        mpLocalMapper->mCurveConfig = mCurveConfig;
        ...
        if (bUseViewer)
        {
            ...
            mpViewer->mCurveConfig = mCurveConfig;
